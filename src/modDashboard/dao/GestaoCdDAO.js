            ...
            INNER JOIN G005 G005 
              ON H019.IDG005 = G005.IDG005
                  ...
                  Left Join G014 G014   
                    ...
                    LEFT JOIN G051 G051 ON G046.IDG046 = G051.IDG046                        
                    LEFT Join G052 G052 On (G052.IDG051 = G051.IDG051)
                    LEFT Join G043 G043 On (G052.IDG043 = G043.IDG043)
      ...
      let result = await con.execute(
        {
          sql: `
              ...
              WHERE DTOCUPAC = (SELECT max(b.DTOCUPAC) FROM G080 b WHERE b.IDG028 = G080.IDG028 )
                        `,
          param: []
        })
        .then((result) => {
          ...
          sql: ` 
                  ...
                  INNER JOIN G022 G022 
                    ...
                    LEFT JOIN G014 G014   
                      ...
                      WHERE G080.TPCDAG = 1 -- BUSCA APENAS OS CD
                      ${sqlWhereAcl}             
                  ) GROUP BY IDG028,NMARMAZE
