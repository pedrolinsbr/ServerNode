module.exports = function (app, cb) {
  ...
  var api = {};
  var dao = app.src.modHoraCerta.dao.ParametrosDAO;
  ...
  api.listarIntervalo = async function (req, res, next) {
    await dao.listarIntervalo(req, res, next)
      .then((result1) => {
        res.json(result1);
      })
      .catch((err) => {
  ...
  api.horarios = async function (req, res, next) {
    await dao.horarios(req, res, next)
      .then((result1) => {
        res.json(result1);
      })
      .catch((err) => {
  ...
  api.intervalos = async function (req, res, next) {
    await dao.intervalos(req, res, next)
      .then((result1) => {
        res.json(result1);
      })
      .catch((err) => {
  ...
  api.excluirIntervalo = async function (req, res, next) {
    await dao.excluirIntervalo(req, res, next)
      .then((result1) => {
        res.json(result1);
      })
      .catch((err) => {
  ...
  api.salvarHorarios = async function (req, res, next) {
    await dao.salvarHorarios(req, res, next)
      .then((result1) => {
        res.json(result1);
      })
      .catch((err) => {
  ...
  api.salvarIntervalo = async function (req, res, next) {
    await dao.salvarIntervalo(req, res, next)
      .then((result1) => {
        res.json(result1);
      })
      .catch((err) => {
  ...
  api.atualizarIntervalo = async function (req, res, next) {
    await dao.atualizarIntervalo(req, res, next)
      .then((result1) => {
        res.json(result1);
      })
      .catch((err) => {
  ...
  api.verificaAgendaCriada = async function (req, res, next) {
    await dao.verificaAgendaCriada(req, res, next)
      .then((result1) => {
        res.json(result1);
      })
      .catch((err) => {
