        ...
        try {
            ...
            var sql = 
                `SELECT 
                    ...
                    CASE 
                        WHEN ((COUNT(T017C.IDT017) > 0) AND (COUNT(T017T.IDT017) > 0)) THEN 'S'
                        ELSE 'N'
                    END SNCOTACA, 
                ...
                LEFT JOIN T017 T017C -- COTACAO CLIENTE
                    ON T017C.IDG046 = G046.IDG046
                    AND T017C.TPCOTACA = 'C'

                LEFT JOIN T017 T017T -- COTACAO TRANSPORTADORA
                    ON T017T.IDG046 = G046.IDG046
                    AND T017T.TPCOTACA = 'T'               
