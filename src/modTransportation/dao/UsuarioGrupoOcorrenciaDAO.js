...
/**
 * @module dao/UserGrupoOcorrencia
 * @description G071.
...
module.exports = function (app, cb) {
  ...
  /**
   * @description Listar um dados da tabela G071.
   *
   * @async
   * @function api/listar
  ...
  api.listar = async function (req, res, next) {
    ...
    try {
      ...
      var [sqlWhere,sqlOrder,sqlPaginate,bindValues] = utils.retWherePagOrd(req.body,'G071',true);

      logger.debug("Variaveis:", sqlWhere, sqlOrder, sqlPaginate, bindValues);

      let result = await con.execute(
        {
          sql: ` Select G071.IDG071,
                        G071.IDG070,
                        G071.PCPARAM,
                        G071.IDS001OC,
                        G071.IDS001,
                        ...
                        S001OC.NMUSUARI AS S001OC_NMUSUARI,
                        COUNT(G071.IdG071) OVER () as COUNT_LINHA
                   From G071 G071
                   Left Join S001 S001 on S001.IDS001 = G071.IDS001
                   Left Join S001 S001OC on S001OC.IDS001 = G071.IDS001OC
                   Left Join G067 G067 on G067.IDG067 = G071.IDG067
  ...
  /**
   * @description Listar um dado na tabela G071.
   *
   * @async
   * @function api/buscar
   * @param {request} req - Possui as requisições para a função.
  ...
  /**
   * @description Salvar um dado na tabela G071.
   *
   * @async
   * @function api/salvar
   * @param {request} req - Possui as requisições para a função.
    ...
    try {
      ...
      let result = await con.insert({
        ...
        colunas: {
          ...
          IDG070: req.body.IDG070,
          PCPARAM: req.body.PCPARAM,
  ...
  /**
   * @description Atualizar um dado na tabela G071, .
   *
   * @async
  ...
  /**
   * @description Delete um dado na tabela G071.
   *
   * @async
