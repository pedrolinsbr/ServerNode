...
module.exports = function (app, cb) {
  ...
  /**
   * @description Listar um dados da tabela G041.
   *
   * @async
   * @function api/listar
  ...
  api.listar = async function (req, res, next) {
    ...
    try {
      ...
      var [sqlWhere,sqlOrder,sqlPaginate,bindValues] = utils.retWherePagOrd(req.body,'G041',true);
      
      logger.debug("Variaveis:", sqlWhere, sqlOrder, sqlPaginate, bindValues);
      
      let result = await con.execute(
        {
          sql: ` Select G041.IDG041,
                        G041.RSSEGURA,
                        G041.CJSEGURA,
                        G041.IESEGURA,
                        G041.DTCADAST,
                        ...
                        G041.IDS001,
                        G041.SNDELETE,
                        COUNT(G041.IdG041) OVER () as COUNT_LINHA
                   From G041 G041`+
                    sqlWhere +
                    sqlOrder +
                    sqlPaginate,
  ...
  /**
   * @description Listar um dado na tabela G041.
   *
   * @async
   * @function api/buscar
   * @param {request} req - Possui as requisições para a função.
  ...
  /**
   * @description Salvar um dado na tabela G041.
   *
   * @async
   * @function api/salvar
   * @param {request} req - Possui as requisições para a função.
    ...
    try {
      ...
      let result = await con.insert({
        ...
        colunas: {
          ...
          RSSEGURA: req.body.RSSEGURA,
          CJSEGURA: req.body.CJSEGURA,
          IESEGURA: req.body.IESEGURA,
  ...
  /**
   * @description Atualizar um dado na tabela G041, .
   *
   * @async
  ...
  /**
   * @description Delete um dado na tabela G041.
   *
   * @async
