      ...
      let result = await con.execute(
          {
              ...
              G024AT.NMTRANSP || ' [' || G024AT.IDG024 || '-' || G024AT.IDLOGOS || ']' AS TRANSAT,
              G051.DTEMICTR,
              G051.CDCTRC,
              G051.DSMODENF,
              G051.NRSERINF,
              ...
              (SELECT MAX(G043.DTENTREG) AS DTENTREG
               FROM G043 G043
               JOIN G052 G052
                 ON G052.IDG043 = G043.IDG043 -- NF COM CTE
               JOIN G043 G043
                 ON G043.IDG043 = G052.IDG043 -- NF
                WHERE G052.IDG051 = G051.IDG051) AS DTENTREG,
              G051.DTENTPLA,
              G051.DTCALDEP,
              G051.CDCARGA,
              G051.IDG046,
              G051.NRFATURA,
              G005CO.NMCLIENT || ' [' || FN_FORMAT_CNPJ_CPF(G005CO.CJCLIENT) || ' - ' ||
              ...
              G051.NRCHADOC
               ...
               JOIN G024 G024AT
               ON G024AT.IDG024 = NVL(G051.IDG024AT,
                            G051.IDG024)
             
               LEFT JOIN G005 G005DE
               ON G005DE.IDG005 = NVL(G051.IDG005RC,
                            G051.IDG005DE) -- DESTINATARIO
              ...
              WHERE G048.IDG046 = :id
         
              ` + ` --ORDER BY G048.IDG048 
              ` + sqlPaginate,
              param: {
                id: req.body.IDG046
              }
