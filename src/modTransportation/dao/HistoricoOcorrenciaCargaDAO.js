...
module.exports = function (app, cb) {
  ...
  /**
   * @description Listar um dados da tabela G012.
   *
   * @async
   * @function api/listar
  ...
  api.listar = async function (req, res, next) {
    ...
    try {
      ...
      var [sqlWhere,sqlOrder,sqlPaginate,bindValues] = utils.retWherePagOrd(req.body,'G012',true);
      
      logger.debug("Variaveis:", sqlWhere, sqlOrder, sqlPaginate, bindValues);
      
      let result = await con.execute(
        {
          sql: ` Select G012.IDG012,
                        G012.DSHISTOR,
                        G012.STCADAST,
                        G012.DTCADAST,
                        COUNT(G012.IdG012) OVER () as COUNT_LINHA
                   From G012 G012`+
                    sqlWhere +
                    sqlOrder +
                    sqlPaginate,
  ...
  /**
   * @description Listar um dado na tabela G012.
   *
   * @async
   * @function api/buscar
   * @param {request} req - Possui as requisições para a função.
  ...
  /**
   * @description Salvar um dado na tabela G012.
   *
   * @async
   * @function api/salvar
   * @param {request} req - Possui as requisições para a função.
  ...
  /**
   * @description Atualizar um dado na tabela G012, .
   *
   * @async
  ...
  /**
   * @description Delete um dado na tabela G012.
   *
   * @async
